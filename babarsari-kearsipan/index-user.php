                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="index-admin.php">Halaman <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item ">
            ...
            <div class="owl-carousel owl-theme js" id="slider1">
                ...
                <div class="item px-2">
                    <div class="fh5co_latest_trading_img_position_relative">
                        ...
                        <div class="fh5co_latest_trading_img_position_absolute"></div>
                        <div class="fh5co_latest_trading_img_position_absolute_1">
                            <a href="berita2-admin.php" class="text-white"> Layanan Arsip Kawasan Yogyakarta Studi Banding ke
                                Arsip UGM </a>
                            <div class="fh5co_latest_trading_date_and_name_color"> Layanan Sistem Informasi Kearsipan
                ...
                <div class="item px-2">
                    <div class="fh5co_latest_trading_img_position_relative">
                        ...
                        <div class="fh5co_latest_trading_img_position_absolute"></div>
                        <div class="fh5co_latest_trading_img_position_absolute_1">
                            <a href="berita3-admin.php" class="text-white"> Kunjungan Tim Layanan Kearsipan Karangsambung
                                Kebumen</a>
                            <div class="fh5co_latest_trading_date_and_name_color"> Layanan Sistem Informasi Kearsipan
                ...
                <div class="item px-2">
                    <div class="fh5co_latest_trading_img_position_relative">
                        ...
                        <div class="fh5co_latest_trading_img_position_absolute"></div>
                        <div class="fh5co_latest_trading_img_position_absolute_1">
                            <a href="berita5-admin.php" class="text-white">3 SDM Layanan Arsip Kawasan Yogyakarta Telah Lulus Mengikuti Uji Kompetensi Tahun 2023</a>
                            <div class="fh5co_latest_trading_date_and_name_color"> Layanan Sistem Informasi Kearsipan
            ...
            <div class="owl-carousel owl-theme" id="slider2">
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita2-admin.php" class="d-block fh5co_small_post_heading"><span class="">Layanan Arsip
                ...
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita1-admin.php" class="d-block fh5co_small_post_heading"><span class="">Pemusnahan
                ...
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita3-admin.php" class="d-block fh5co_small_post_heading"><span class="">Kunjungan Team
                ...
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita5-admin.php" class="d-block fh5co_small_post_heading"><span class="">Kunjungan
                ...
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita5-admin.php" class="d-block fh5co_small_post_heading"><span class="">3 SDM Layanan Arsip Kawasan Yogyakarta Telah Lulus Mengikuti Uji Kompetensi Tahun 2023</span></a>
                            <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2020</div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container paddding">
            <div class="row mx-0">
                <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          
                    <div>
                        <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Pojok Arsip</div>
                    </div>
                    <div class>
                        <div class>
                            <div class>
                                <div class><img src="images/POJOK ARSIP.png" style="width: 725px;height: 400px;" alt="" /></div>
                ...
                <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                    ...
                    <div class="row pb-3">
                        <div class="col-5 align-self-center">
                            <img src="images/kunjungankedinasperpustakaanasrip.jpg" alt="img" class="fh5co_most_trading" />
                        </div>
                        <div class="col-7 paddding">
                            <div class="most_fh5co_treding_font"> KUNJUNGAN LAYANAN ARSIP YOGYAKARTA KE DINAS PERPUSTAKAAN DAN ARSIP DAERAH.</div>
