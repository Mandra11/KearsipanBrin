        ...
        <div class="container paddding">
            <div class="row mx-0">
                <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                    ...
                    <div class="row pb-4">
                        ...
                        <div class="col-md-7 animate-box">
                            <a href="berita1-guest.php" class="fh5co_magna py-2"> Pemusnahan Arsip Tahap 1 </a> <a href="#"
                    ...
                    <div class="row pb-4">
                        ...
                        <div class="col-md-7">
                            <a href="single-guest.php" class="fh5co_magna py-2"> Pemusnahan Arsip Tahap 1 . </a> <a href="#"
                                class="fh5co_mini_time py-3">Layanan Sistem Informasi Kearsipan Yogyakarta -
                                April 18,2016 </a>
                            <div class="fh5co_consectetur">Pada
                                hari Senin, tanggal 11 Maret 2023, Tim Layanan Arsip Kawasan Yogyakarta Badan Riset dan
                ...
                <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                    ...
                    <div>
                        <div class="fh5co_heading fh5co_heading_border_bottom pt-3 py-2 mb-4">Sedang Populer</div>
                    </div>
                    <div class="row pb-3">
            ...
            <div class="owl-carousel owl-theme" id="slider2">
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        <div class="fh5co_news_img"><img src="images/kunjunganugm.png" alt="" /></div>
                        <div>
                            <a href="berita2-guest" class="d-block fh5co_small_post_heading"><span class="">Layanan Arsip Kawasan
                ...
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita4-guest" class="d-block fh5co_small_post_heading"><span class="">Layanan Arsip Kawasan
                                    Yogyakarta Studi Banding Kearsipan UGM </span></a>
                            <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                        </div>
                    </div>
                ...
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        <div class="fh5co_news_img"><img src="images/pemusnahanarsip.jpeg" alt="" /></div>
                        <div>
                            <a href="berita1-guest" class="d-block fh5co_small_post_heading"><span class="">Pemusnahan Arsip Tahap
                                    1</span></a>
                            <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                        </div>
                    </div>
                ...
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita1-guest.php" class="d-block fh5co_small_post_heading"><span class="">Pemusnahan Arsip Tahap
                                    1</span></a>
                            <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                        </div>
                    </div>
