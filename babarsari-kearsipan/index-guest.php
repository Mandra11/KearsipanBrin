                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-9 align-self-center fh5co_mediya_right">
                        ...
                        <select class="form-control fh5co_text_select_option" onchange="navigateToPage(this.value)">
                            ...
                            <option value="login-page.php">Login</option>
                        </select>
                    </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="index-guest.php">Halaman <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item ">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-lg-4 ">
                    ...
                    <a href="berita1-guest.php" class="footer_img_post_6"><img src="images/pemusnahanarsip.jpeg"
                            alt="img" /></a>
                    <a href="berita1-guest.php" class="footer_img_post_6"><img src="images/pemusnahan arsip foto ke 2.jpg"
                            alt="img" /></a>
                    <a href="profil-guest.php" class="footer_img_post_6"><img src="images/STRUKTUR ORGANISASI_page-0001.jpg"
                            alt="img" /></a>
                    <a href="berita3-guest.php" class="footer_img_post_6"><img src="images/kunjunganarsipkarangsambung.jpg"
                            alt="img" /></a>
                    <a href="berita2-guest.php" class="footer_img_post_6"><img src="images/kunjunganugm.png" alt="img" /></a>
